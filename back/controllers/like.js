...
exports.sauceLike = (req, res, next) => {
    ...
    Sauces.findOne({ _id: req.params.id })
        .then((oneSauces) => {
            ...
            if (oneSauces.usersLiked.includes(req.auth.userId) && req.body.like === -1) {
            ...
            else if (oneSauces.usersDisliked.includes(req.auth.userId) && req.body.like === 1) {
                // Mets à jour les données avec inc qui ajoute la valeur à likes et pull qui retire l'utilisateur au tableau usersliked
            ...
            else if (!oneSauces.usersLiked.includes(req.auth.userId) && req.body.like === 1) {
            ...
            else if (oneSauces.usersLiked.includes(req.auth.userId) && req.body.like === 0) {
                // Mets à jour les données avec inc qui ajoute la valeur à likes et pull qui retire l'utilisateur au tableau usersliked
            ...
            else if (oneSauces.usersDisliked.includes(req.auth.userId) && req.body.like === 0) {
                // Mets à jour les données avec inc qui ajoute la valeur à likes et pull qui retire l'utilisateur au tableau usersliked
